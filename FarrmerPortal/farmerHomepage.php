...
<body class="page-about">
  ...
  <main id="main">
    ...
    <div class="features container">
                <h1 style="font-weight: bold;color:black; text-align:center"> Taking Agriculture to Another Level</h1>
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">Sell your products </h4>
                               <br>
                               <h5 class="card-text">Upload and advertise/market your products  </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               ...
                               <br>
                               <h5 class="card-text">Get in direct touch with the buyer to satisfy their need </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">From farm to doorstep</h4>
                               <br>
                               <h5 class="card-text">Get in direct touch with the buyer and deliver plants fresh from the farm</h5>
                          </div>
                     </div>
                </div>
           </div>

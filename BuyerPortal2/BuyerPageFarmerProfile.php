...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="list-group moblists">
        ...
        if (isset($_SESSION['phonenumber'])) {
            ...
            echo "<a href='saveforlater.php' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)'>Save For Later</a>";
            echo "<a href='#' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)'>Subscriptions</a>";
            echo "<a href='#farmer.php' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)'>Farmers</a>";
            echo "<a href='../Includes/logout.php' class='list-group-item list-group-item-action ' style='background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)'>Logout</a>";
        } else {
                    ...
                    <div class="col-md-6 " style="background-color:#292b2c;">
                        <div class="row">
                                <div class="col-md-12 ">
                                    ...
                                    <span>
                                        <h4 style='color:rgba(86, 184, 230, 0.8);' class='text-center ''>Get Latest Notifications<br></h4>
                                    ...
                                    <span>
                                        <h4 style='color:rgba(86, 184, 230, 0.8);' class='text-center ''>Report Query <br></h4>
               ...
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                              <p><u><a href="#">Hurudza Portal</a></u> is a Modern day market plae</p>
                              <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="#" target="_blank">Hurudza</a></p>
                         </div>
                         </hr>
                    </div>
               </div>

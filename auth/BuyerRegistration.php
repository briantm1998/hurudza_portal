	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
					<div class="card-header" style="background-color:#292b2c"><h4 style="font-style:bold;color:rgba(86, 184, 230, 0.8)">Register</h4></div>
...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
		...
		$query = "insert into buyerregistration (buyer_name,buyer_phone,buyer_addr,buyer_bank,buyer_mail,buyer_username,buyer_password) 
		values ('$name','$phonenumber','$address','$account',

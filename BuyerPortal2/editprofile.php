    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="list-group moblists">
                <a href="#" class="list-group-item list-group-item-action " style="background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)">
                    Profile
                </a>
                <a href="#" class="list-group-item list-group-item-action" style="background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)">Transactions</a>
                <a href="#" class="list-group-item list-group-item-action" style="background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)">subscriptions</a>
                <a href="" class="list-group-item list-group-item-action" style="background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)">Farmers</a>
                <a href="index.html" class="list-group-item list-group-item-action " style="background-color:#292b2c;text-align:center;color:rgba(86, 184, 230, 0.8)">Logout</a>
            </div>
        </div>
...
<br>
    ...
    <div class="container" >
        ...
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#292b2c;color:rgba(86, 184, 230, 0.8)">Confirm</button>
        <br>
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#292b2c;color:rgba(86, 184, 230, 0.8)">Change Password</button>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                        <p><u><a href="#">Hurudza Portal</a></u> is a Modern day market place</p>
                        <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Hurudza Portal</a></p>
                </div>
                </hr>
            </div>
        </div>

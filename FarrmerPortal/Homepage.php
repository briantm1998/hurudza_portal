...
<body>
     ...
     <div class="whatsnew">
          ...
          <div class="f1 f4">
               <div class="t1 t4"> ECOCASH & OTHER OPTIONS</div>
     ...
     <h3><span> CONTACT US FOR SUPPORT </span></h3>
     </div>
     <div class="morefooter">

          <div class="call">
               <i class="fas fa-phone-alt call_color"></i>
               <a href="#" style="color:black;">+263 785 68985 </a>
          </div>
     ...
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;">@Hurudza</a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">info@hurudza.net</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="text-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 </h5>
     </div>
